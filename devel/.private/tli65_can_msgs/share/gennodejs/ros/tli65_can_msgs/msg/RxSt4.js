...
class RxSt4 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('retarder_torque_percentage')) {
        ...
        this.retarder_torque_percentage = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.retarder_torque_percentage, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RxSt4(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [retarder_torque_percentage]
    data.retarder_torque_percentage = _deserializer.float64(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'tli65_can_msgs/RxSt4';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'b6fda05c73294aeca9c625d7dd4030fd';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.retarder_torque_percentage !== undefined) {
      ...
      resolved.retarder_torque_percentage = 0.0
    }

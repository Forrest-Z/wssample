...
// (in-package g29_force_feedback.msg)
...
class tstForceFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new tstForceFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new tstForceFeedback(null);
...
module.exports = tstForceFeedback;

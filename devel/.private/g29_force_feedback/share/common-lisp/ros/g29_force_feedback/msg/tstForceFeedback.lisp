...
(cl:defclass <tstForceFeedback> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass tstForceFeedback (<tstForceFeedback>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <tstForceFeedback>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'tstForceFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name g29_force_feedback-msg:<tstForceFeedback> is deprecated: use g29_force_feedback-msg:tstForceFeedback instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <tstForceFeedback>))
...
(cl:defmethod calforce-val ((m <tstForceFeedback>))
...
(cl:defmethod finalforce-val ((m <tstForceFeedback>))
...
(cl:defmethod pforce-val ((m <tstForceFeedback>))
...
(cl:defmethod iforce-val ((m <tstForceFeedback>))
...
(cl:defmethod dforce-val ((m <tstForceFeedback>))
...
(cl:defmethod error-val ((m <tstForceFeedback>))
...
(cl:defmethod current_angle-val ((m <tstForceFeedback>))
  ...
  (current_angle m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <tstForceFeedback>) ostream)
  "Serializes a message object of type '<tstForceFeedback>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <tstForceFeedback>) istream)
  "Deserializes a message object of type '<tstForceFeedback>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<tstForceFeedback>)))
  "Returns string type for a message object of type '<tstForceFeedback>"
  "g29_force_feedback/tstForceFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'tstForceFeedback)))
  "Returns string type for a message object of type 'tstForceFeedback"
  "g29_force_feedback/tstForceFeedback")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<tstForceFeedback>)))
  "Returns md5sum for a message object of type '<tstForceFeedback>"
  "75d82f66d771fc3961daa29af4f7949f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'tstForceFeedback)))
  "Returns md5sum for a message object of type 'tstForceFeedback"
  "75d82f66d771fc3961daa29af4f7949f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<tstForceFeedback>)))
  "Returns full string definition for message of type '<tstForceFeedback>"
  (cl:format cl:nil "std_msgs/Header header~%float64 calforce~%float64 finalforce~%float64 pforce~%float64 iforce~%float64 dforce~%float64 error~%float64 current_angle~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'tstForceFeedback)))
  "Returns full string definition for message of type 'tstForceFeedback"
  (cl:format cl:nil "std_msgs/Header header~%float64 calforce~%float64 finalforce~%float64 pforce~%float64 iforce~%float64 dforce~%float64 error~%float64 current_angle~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <tstForceFeedback>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <tstForceFeedback>))
  "Converts a ROS message object to a list"
  (cl:list 'tstForceFeedback

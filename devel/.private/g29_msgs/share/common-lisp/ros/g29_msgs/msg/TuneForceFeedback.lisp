...
(cl:defmethod cl:initialize-instance :after ((m <TuneForceFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TuneForceFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name g29_msgs-msg:<TuneForceFeedback> is deprecated: use g29_msgs-msg:TuneForceFeedback instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:header-val is deprecated.  Use g29_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'calforce-val :lambda-list '(m))
(cl:defmethod calforce-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:calforce-val is deprecated.  Use g29_msgs-msg:calforce instead.")
  (calforce m))

(cl:ensure-generic-function 'finalforce-val :lambda-list '(m))
(cl:defmethod finalforce-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:finalforce-val is deprecated.  Use g29_msgs-msg:finalforce instead.")
  (finalforce m))

(cl:ensure-generic-function 'pforce-val :lambda-list '(m))
(cl:defmethod pforce-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:pforce-val is deprecated.  Use g29_msgs-msg:pforce instead.")
  (pforce m))

(cl:ensure-generic-function 'iforce-val :lambda-list '(m))
(cl:defmethod iforce-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:iforce-val is deprecated.  Use g29_msgs-msg:iforce instead.")
  (iforce m))

(cl:ensure-generic-function 'dforce-val :lambda-list '(m))
(cl:defmethod dforce-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:dforce-val is deprecated.  Use g29_msgs-msg:dforce instead.")
  (dforce m))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:error-val is deprecated.  Use g29_msgs-msg:error instead.")
  (error m))

(cl:ensure-generic-function 'current_angle-val :lambda-list '(m))
(cl:defmethod current_angle-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:current_angle-val is deprecated.  Use g29_msgs-msg:current_angle instead.")
  (current_angle m))

(cl:ensure-generic-function 'derror-val :lambda-list '(m))
(cl:defmethod derror-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:derror-val is deprecated.  Use g29_msgs-msg:derror instead.")
  (derror m))

(cl:ensure-generic-function 'force2-val :lambda-list '(m))
(cl:defmethod force2-val ((m <TuneForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_msgs-msg:force2-val is deprecated.  Use g29_msgs-msg:force2 instead.")
  (force2 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TuneForceFeedback>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'derror))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'force2))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TuneForceFeedback>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'force2) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TuneForceFeedback>)))
  ...
  "bf7818849acfc8f3815bdde80fa9e88c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TuneForceFeedback)))
  "Returns md5sum for a message object of type 'TuneForceFeedback"
  "bf7818849acfc8f3815bdde80fa9e88c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TuneForceFeedback>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%float64 calforce~%float64 finalforce~%float64 pforce~%float64 iforce~%float64 dforce~%float64 error~%float64 current_angle~%float64 derror~%float64 force2~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TuneForceFeedback)))
  "Returns full string definition for message of type 'TuneForceFeedback"
  (cl:format cl:nil "std_msgs/Header header~%float64 calforce~%float64 finalforce~%float64 pforce~%float64 iforce~%float64 dforce~%float64 error~%float64 current_angle~%float64 derror~%float64 force2~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))

...
class SteerSpeedYawRate {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SteerSpeedYawRate(null);
  ...
  static datatype() {
    ...
    return 'localization_msgs/SteerSpeedYawRate';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '2d749bd596c0594c11768cf518b25124';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SteerSpeedYawRate(null);
...
module.exports = SteerSpeedYawRate;

...
class Frontend_TLdisplay {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Frontend_TLdisplay(null);
  ...
  static datatype() {
    ...
    return 'frontend_msgs/Frontend_TLdisplay';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e622ba7a39d3ca14b4c60375b5cf0f77';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Frontend_TLdisplay(null);
...
module.exports = Frontend_TLdisplay;

// Generated by gencpp from file frontend_msgs/Frontend_TLdisplay.msg
// DO NOT EDIT!


#ifndef FRONTEND_MSGS_MESSAGE_FRONTEND_TLDISPLAY_H
#define FRONTEND_MSGS_MESSAGE_FRONTEND_TLDISPLAY_H
...
struct Frontend_TLdisplay_
{
  typedef Frontend_TLdisplay_<ContainerAllocator> Type;
  ...
  Frontend_TLdisplay_(const ContainerAllocator& _alloc)
    : left_light(0)
    , right_light(0)
    , near_light(0)
    , far_light(0)
  ...
  typedef boost::shared_ptr< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> const> ConstPtr;

}; // struct Frontend_TLdisplay_

typedef ::frontend_msgs::Frontend_TLdisplay_<std::allocator<void> > Frontend_TLdisplay;

typedef boost::shared_ptr< ::frontend_msgs::Frontend_TLdisplay > Frontend_TLdisplayPtr;
typedef boost::shared_ptr< ::frontend_msgs::Frontend_TLdisplay const> Frontend_TLdisplayConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >
{
  ...
  static const char* value(const ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe622ba7a39d3ca14ULL;
  static const uint64_t static_value2 = 0xb4c60375b5cf0f77ULL;
};

template<class ContainerAllocator>
struct DataType< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::frontend_msgs::Frontend_TLdisplay_<ContainerAllocator>& v)
  {
    s << indent << "left_light: ";
...
#endif // FRONTEND_MSGS_MESSAGE_FRONTEND_TLDISPLAY_H

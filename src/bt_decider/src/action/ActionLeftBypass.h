...
class ActionLeftBypass : public AsyncActionNode {
  public:
    ActionLeftBypass(const string &name, const NodeConfiguration &config)
    ...
    virtual NodeStatus tick() override {
        ...
        strategy.lat_strategy = "left_bypass";

        pub_lat_strategy_.publish(strategy);
        ROS_INFO_STREAM("[decider] left bypass !");

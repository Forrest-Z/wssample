...
// 2021.3 xuy, for truck back axle round track, minimal turn radius R = 12
// R = 12, 6.75 DEG
const float Node3D::dy[] = {0, -0.0831786, 0.0831786};
const float Node3D::dx[] = {1.41372, 1.410448, 1.410448};
...
void Node3D::updateG() {
    ...
    // reverse driving
        ...
        if (pred->prim != prim) {
            ...
            if (pred->prim < 3) {
                g += dx[0] * Constants::penaltyTurning *
                     Constants::penaltyReversing * Constants::penaltyCOD;
            } else {
                g += dx[0] * Constants::penaltyTurning *

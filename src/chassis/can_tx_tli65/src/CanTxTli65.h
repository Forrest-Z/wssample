...
class CanTxTli65 {
  ...
  private:
    string highspeed_topic_;
    string lowspeed_topic_;
    string node_pub_topic_;

    uint8_t throttle_msg_counter_;
    uint8_t XBR_msg_counter_;
    uint8_t EPB_msg_counter_;
    uint8_t retarder_msg_counter_;
    uint8_t steer_msg_counter_;
    uint8_t gear_msg_counter_;
    uint8_t hang_msg_counter_;
    ...
    void ProcLowspeed(const control_msgs::LowspeedControl &msg);
    void ProcHighspeed(const control_msgs::HighspeedControl &msg);
    ...
    // sub
    ros::Subscriber sub_highspeed_;
    ros::Subscriber sub_lowspeed_;
